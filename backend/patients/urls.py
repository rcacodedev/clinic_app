...
urlpatterns = [
    ...
    path('documentos/', PatientDocumentListCreateView.as_view(), name="list-create-document"),
    path('documentos/<int:pk>/eliminar/', PatientDocumentDeleteView.as_view(), name='delete-document'),
]
